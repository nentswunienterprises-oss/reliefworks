...
export function registerRoutes(app: Express) {
  ...
  app.post("/api/admin/subscriptions/checkout-link", requireAdmin, async (req, res) => {
    const parsedId = z.coerce.number().int().positive().safeParse(
    ...
    try {
      ...
      const payfastResult = createPayfastSubscriptionUrl(
        ...
        },
        {
          ...
          frequency: subscription.interval === "year" ? "6" : "3",
          cycles: "0",
        },
      );
