...
const jsonPressureType = z.preprocess(
...
export const adminQuoteSchema = z.object({
  ...
  depositPercentage: z.number().int().min(0).max(100).nullable(),
...
export const adminCreateQuoteInputSchema = z.object({
  ...
  paymentTermsType: paymentTermsTypeSchema.default('full_upfront'),
